...
class ClassicalChinese(PredefinedRuleset):
    ...
    def loadRules(self):
        ...
        self.meldRules.add(Rule('Exposed Kong of Terminals', 'FExposedTerminalsKong',
            explainTemplate='{meldName}', points=16))
        self.meldRules.add(Rule('Exposed Kong of Honors', 'FExposedHonorsKong',
            explainTemplate='{meldName}', points=16))

        self.meldRules.add(Rule('Exposed Pung', 'FExposedMinorPung',
            explainTemplate='{meldName}', points=2))
        self.meldRules.add(Rule('Exposed Pung of Terminals', 'FExposedTerminalsPung',
            explainTemplate='{meldName}', points=4))
        self.meldRules.add(Rule('Exposed Pung of Honors', 'FExposedHonorsPung',
            explainTemplate='{meldName}', points=4))

        # concealed melds:
        self.meldRules.add(Rule('Concealed Kong', 'FConcealedMinorKong',
            explainTemplate='{meldName}', points=16))
        self.meldRules.add(Rule('Concealed Kong of Terminals', 'FConcealedTerminalsKong',
            explainTemplate='{meldName}', points=32))
        self.meldRules.add(Rule('Concealed Kong of Honors', 'FConcealedHonorsKong',
            explainTemplate='{meldName}', points=32))

        self.meldRules.add(Rule('Concealed Pung', 'FConcealedMinorPung',
            explainTemplate='{meldName}', points=4))
        self.meldRules.add(Rule('Concealed Pung of Terminals', 'FConcealedTerminalsPung',
            explainTemplate='{meldName}', points=8))
