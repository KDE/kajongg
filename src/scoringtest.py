...
class FalseColorGame(Base):
    """false color games"""
    def testMe(self):
        self.scoreTest('c1c1c1 c7c7c7 c2c3c4 c5c5 c6c6c6 Lc5c5c5', [Win(32, 3), Win(28)])
        self.scoreTest('c1c2c3 wewewe drdrdr dbdb DgDgDg Ldbdbdb', [Win(44, 4), Win(38, 2)], winds='wn')
        self.scoreTest('s1s1s1 wewewe c2c3c4 c5c5 c6c6c6 Lc5c5c5', [Win(34), Win(30)], winds='wn')
        self.scoreTest('RB1B1B1B1B2B3B4B5B6B7B8B9DrDr fe ys LDrDrDr', [Win(46, 2), NoWin()])
        self.scoreTest('b1B1B1b1 RB2B3B4B5B6B7B8B8B8 DrDr fe ys LDrDrDr', [Win(74, 2), NoWin()])
        self.scoreTest('b1B1B1b1 RB2B2B2B5B6B7B8B8B8 DrDr fe ys LDrDrDr', [Win(78, 3), Win(72, 1)], winds='we')
...
class SquirmingSnake(Base):
    """the winding snake"""
    def testMe(self):
        self.scoreTest('c1c1c1 c3c4c5 c9c9c9 c6c7c8 RC2C2 Lc1c1c1c1', [Win(limits=1), NoWin()])
        self.scoreTest('c1c1c1 c4c5c6 c9c9c9 c6c7c8 RC2C2 Lc1c1c1c1', [Win(points=28, doubles=3), NoWin()])
        self.scoreTest('c1c1c1 c3c4c5 c9c9c9 c6c7c8 RS2S2 Lc1c1c1c1', [Win(points=28), NoWin()])
        self.scoreTest('s1s1s1 s2s3s4 s9s9s9 s6s7s8 RS5S5 Ls1s1s1s1', [Win(limits=1), NoWin()])
        self.scoreTest('b1b1b1 c3c4c5 c6c7c8 c9c9c9 RC2C2 Lc3c3c4c5', [Win(points=28), NoWin()])
        self.scoreTest('b1b1b1 c3c4c5 c6c7c8 c9c9c9 RC2C2 Lc4c3c4c5', [Win(points=30), NoWin()])
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C5 LC5', Win(limits=1))
        self.scoreTest('RC1C1C1C3C4C5C6C7C8C9C9C9C5 LC3', [NoWin(16), NoWin(limits=0.4)])
        self.scoreTest('RC1C1C2C3C4C5C6C7C8C9C9C9C5 LC3', [NoWin(8), NoWin(limits=0.4)])
class Purity(Base):
    """Purity BMJA"""
    def testMe(self):
        self.scoreTest('b1b1b1b1 RB2B3B4B5B6B7B8B8B2B2B2 fe fs fn fw LB3B2B3B4',
                [Win(points=60, doubles=4), NoWin()])
        self.scoreTest('b1b1b1 RB3B3B3B6B6B6B8B8B2B2B2 fe fs fn fw LB3', [Win(54, 6), Win(54, 7)])
        self.scoreTest('b1b1b1 RB3B3B3B6B6B8B8B2B2B2 fe fs fn fw LB3', [NoWin(28, 1), NoWin(28, 6)])
        self.scoreTest('c1C1C1c1 c3c3c3 c8c8c8 RC4C5C6C7C7 fs fw ys yw Lc8c8c8c8',
...
class TrueColorGame(Base):
    ...
    def testMe(self):
        self.scoreTest('b1b1b1b1 RB2B3B4B5B6B7B8B8B2B2B2 fe fs fn fw LB3B2B3B4',
                [Win(points=60, doubles=4), NoWin()])
        self.callingTest('RB1B2B3B4B5B5B6B6B7B7B8B8B8 LB1', ['b1b3b4b6b7b9', ''])
        self.scoreTest('b1b1b1B1 RB2B3B4B5B6B7B8B8B2B2B2 fe fs fn fw LB3B2B3B4', [Win(limits=1), NoWin()])
class OnlyConcealedMelds(Base):
    """only concealed melds"""
    def testMe(self):
        self.scoreTest('RB1B1B1B1B2B3B4B5B6B7B8B9DrDr fe ys LDrDrDr', [Win(46, 2), NoWin()])
        self.scoreTest('RB1B1B1B2B2B2B4B4B4B7B8B9DrDr fe ys LDrDrDr', [Win(54, 3), Win(48, 1)], winds='we')
        self.scoreTest('b1B1B1b1 RB2B3B4B5B6B7B8B8B8DrDr fe ys LDrDrDr', [Win(74, 2), NoWin()])
        self.scoreTest('b1B1B1b1 RB2B2B2B5B6B7B8B8B8DrDr fe ys LDrDrDr', [Win(78, 3), Win(72, 1)], winds='we')

class LimitHands(Base):
    """various limit hands"""
    def testMe(self):
        self.scoreTest('c1c1c1 c9c9 b9b9b9b9 s1s1s1 s9s9s9 Lc1c1c1c1', Win(limits=1))
        self.scoreTest('c1c1c1c1 drdr wewewewe c3c3c3C3 s1S1S1s1 Ldrdrdr', Win(limits=1))
        self.scoreTest('drdr c1c1c1c1 wewewewe c3c3c3C3 s1S1S1s1 Ldrdrdr', Win(limits=1))
        self.scoreTest('c1c1c1c1 wewewewe c3c3c3C3 s1S1S1s1 drdr Ldrdrdr', Win(limits=1))
class AllGreen(Base):
    """the green hand"""
    def testMe(self):
        self.scoreTest('c1c1c1 c7c7c7 c2c3c4 c5c5 c6c6c6 Lc5c5c5', [Win(32, 3), Win(28)])
        self.scoreTest('b2b2b2b2 RDgDgDg b6b6b6 b4b4b4 b8b8 Lb6b6b6b6', Win(limits=1))
        self.scoreTest('b2b2b2b2 RDgDg b6b6b6 b4b4b4 b8b8 Lb6b6b6b6', [NoWin(14), NoWin(limits=0.4)])
        self.scoreTest('b1b1b1b1 RDgDgDg b6b6b6 b4b4b4 b8b8 Lb6b6b6b6', [Win(48, 3), Win(48, 2)])
class NineGates(Base):
    """the nine gates"""
        # DMJL allows 1..9 as last tile, BMJA allows only 2..8
    def testMe(self):
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C5 LC5', Win(limits=1))
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C5 LC6', [Win(limits=1), Win(limits=1)])
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C9 LC9', [Win(limits=1), NoWin()])
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C9 LC9', [Win(limits=1), NoWin()])
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C5 LC2', Win(limits=1))
        self.scoreTest('RC1C1C1C2C3C4C5C6C7C8C9C9C9C9 LC1', [Win(limits=1), NoWin()])
        self.scoreTest('RC1C1C2C3C4C5C6C7C8C9C9C9C9 LC1', NoWin(8))
        self.scoreTest('RC1C1C2C3C4C5C6C7C8C8C9C9C9 LC1', [NoWin(8), NoWin(limits=0.4)])
class Manual(Base):
...
class ThirteenOrphans(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('RC1C9B9B1S1S9S9WeDgWnWwDbDr LDb', [NoWin(), NoWin(limits=0.4)])
...
class FourBlessingsOverTheDoor(Base):
    """lots of winds"""
    def testMe(self):
        self.scoreTest('b1b1 wewewe wswsws WnWnWn wwwwwwww Lb1b1b1', Win(limits=1))
...
class AllHonours(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('wewe wswsws RWnWnWn wwwwwwww b1b1 Lwewewe', [NoWin(30, 2), NoWin(30, 1)], winds='ne')
...
class FourfoldPlenty(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('b3B3B3b3 c1C1C1c1 b1b1b1b1 s3s3s3s3 wewe Lwewewe', Win(limits=1))
        self.scoreTest('b3B3B3b3 c1C1C1c1 b1b1b1b1 s3s3s3s3 WeWe LWeWeWe', Win(limits=1))
        self.scoreTest('b3b3 c1C1C1c1 b1b1b1b1 s3s3s3s3 wewewewe Lb3b3b3', Win(limits=1))
        self.scoreTest('b3b3b3b3 c1c1 b1b1b1b1 s3s3s3s3 wewewewe Lc1c1c1', Win(limits=1))
        self.scoreTest('b3b3b3b3 RC1 b1b1b1b1 s3s3s3s3 wewewewe', [NoWin(48, 2), NoWin(limits=0.4)])
...
class ThreeGreatScholars(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('dgdgdg RDrDrDrDbDb s4s4s4 c5c5', [NoWin(16, 3), NoWin(limits=0.4)])
        self.scoreTest('dgdgdg RDrDrDrDbDbDb s4s5s6 c5c5', [Win(limits=1), Win(40, 3)])
        # calling for Three Great Scholars:
        self.scoreTest('s2s2 RDgDgDgDbDbDbDrDrDr b2b2b2b2 Ls2s2s2', Win(limits=1))
        self.scoreTest('RDgDgDgDbDbDbDrDrDrS2 b2b2b2b2 LDbDbDbDb', [NoWin(32, 6), NoWin(limits=0.4)])
        # 40, 5 is more than 0.4 limits:
        self.scoreTest('RS2DgDgDgDbDbDbDrDrDr wewewewe LDbDbDbDb', [NoWin(40, 8), NoWin(40, 5)])
class ThreeConcealedPungs(Base):
    """three concealed pungs"""
    def testMe(self):
        self.scoreTest('RB2B2B2S1S1S1B1B1B1B4B4 c9c9c9c9 LB2B2B2B2', [Win(58, 2), Win(58, 1)])
        self.scoreTest('RB2B2B2S1S1S1B4B4 b1b1b1 c9c9c9c9 LB2B2B2B2', Win(54, 1))
        self.scoreTest('RB2B2B2S1S1S1B4B4 b1b1b1 c9c9c9C9 LB2B2B2B2', [Win(54, 2), Win(54, 1)])
...
class Terminals(Base):
    ...
    def testMe(self):
        # must disallow chows:
        self.scoreTest('b1b1 c1c2c3 c1c2c3 c1c2c3 c1c2c3 Lb1b1b1', [Win(26, 1), NoWin()])
        self.scoreTest('b1b1 c1c2c3 c9c9c9 s1s1s1 s9s9s9 Lb1b1b1', [Win(38), Win(32)])
        self.scoreTest('b1b1 c1c1c1 c9c9c9 s1s1s1 s9s9s9 Lb1b1b1', Win(limits=1))
        self.scoreTest('RB1 c1c1c1 c9c9c9 s1s1s1 s9s9s9', [NoWin(16), NoWin(limits=0.4)])
class LongHand(Base):
    """long hand"""
    def testMe(self):
...
class MJ(Base):
    ...
    def testMe(self):
        self.scoreTest('RB1B1B1B2B2B2B3B4 wnwnwn wewewe Lwnwnwnwn', [Win(36, 3), Win(36, 2)])
        self.scoreTest('RB1B1B1B2B2B2B3B3B3S1S1 c3c4c5 Lc3c3c4c5', [Win(36, 1), Win(36)])
        self.scoreTest('RB1B1B1B2B2B2B3B3S1S2S3 c3c4c5 Lc3c3c4c5', [Win(32), NoWin()])
        self.scoreTest('c1C1C1c1 b5B5B5b5 c2C2C2c2 c3C3C3c3 RC4B6 fs fw fn fe LC4', NoWin())
        self.scoreTest('wewewe wswsws wnwnwnWn RWwWwWwC6 LC6', [NoWin(32, 4), NoWin(limits=0.4)])
...
class LastIsOnlyPossible(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('b3B3B3b3 wewewe RDbDbDbS1S1S1S3S3 LS3S3S3', [Win(60, 5), Win(58, 4)])
        self.scoreTest('b3B3B3b3 wewewe RDbDbDbS1S1S1S4S4 LS4S4S4', [Win(62, 5), Win(58, 4)])
        self.scoreTest('b3B3B3b3 wewewe RDbDbDbS1S1S1S3S3 LS1S1S1S1', [Win(58, 5), Win(58, 4)])
        self.scoreTest('s9s9s9 s8s8s8 RDgDgS1S2S3S3S4S5 LS3 fe', [Win(34, 1), NoWin()])
        self.scoreTest('s9s9s9 s8s8s8 RDgDgS1S2S3S4S4S4 LS3 fe', [Win(40, 1), Win(38, 1)])
        self.scoreTest('s9s9s9 s8s8s8 RDgDgS1S2S3S4S5S6 LS6 fe', [Win(34, 1), NoWin()])
        self.scoreTest('s9s9s9 s8s8s8 RDgDgS1S2S3S7S8S9 LS7 fe', [Win(36, 1), NoWin()])

class TripleKnitting(Base):
    """triple knitting BMJA"""
    def testMe(self):
        self.scoreTest('RS2B2C2S4B4C4S6B6C6S7B7C7 s8b8 Ls8s8b8', [None, Win(limits=0.5)])
        self.scoreTest('RB2C2S4B4C4S6B6C6S7B7C7S8B8 LS8', [NoWin(), NoWin(limits=0.2)])
        self.scoreTest('RS2B2C2S4B4C4S6B6C6S7B7C7S8 LS8', [NoWin(), NoWin(limits=0.2)])
        self.scoreTest('RS2B2C2S7B7C7S4B4C4S6B6C6 s8b8 Ls8s8b8', [NoWin(), Win(limits=0.5)])
...
class Knitting(Base):
    """knitting BMJA"""
    def testMe(self):
        self.scoreTest('RS2B2S3B3S4B4S5B5S6B6S7B7 s9b9 Ls9s9b9', [NoWin(), Win(limits=0.5)])
        self.scoreTest('RS2B2S3B3B4S5B5S6B6S7B7 S9B9 LS9', [NoWin(), NoWin(limits=0.2)])
...
class AllPairHonors(Base):
    ...
    def testMe(self):
        ...
        self.scoreTest('RWeWeS1S1B9B9DgDgDrDrWsWwWw LS1', [NoWin(6), NoWin(limits=0.2)], winds='wn')
...
class CallingHands(Base):
    ...
    def testMe(self):
        ...
        self.callingTest('RDbDgDrWsWwWeWnB1B9C1S1S9C9 LWe', 'dbdgdrwewswwwns1s9b1b9c1c9')

class Recursion(Base):
    """recursion in Hand computing should never happen"""
    def testMe(self):
        self.scoreTest('c6c6c6C6 fe fs RS8S8C1C2C3C4C5C7C8C9 LC6', [NoWin(16), NoWin(16, 1)])
        self.scoreTest('c6c6c6C6 fe fs RS8S8C1C2C3C4C5C7C8C9 LC7', [NoWin(16), NoWin(16, 1)])
