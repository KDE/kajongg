...
class Regex(unittest.TestCase):
    ...
    def testAllGreen(self):
        ...
        self.scoreTest(r'b1b1b1b1 RDgDgDg b6b6b6 b4b4b4 b8b8 Mee Lb6b6b6b6', Score(points=48, doubles=3))
...
# TODO: test playing without a limit
    ...
    def testRest(self):
        ...
        self.scoreTest(r's2s2s2 RDgDgDbDbDbDrDrDr b2b2b2b2 Mee Ls2s2s2s2', Score(48, 4))
        self.scoreTest(r's2s2 RDgDgDgDbDbDbDrDrDr b2b2b2b2 Mee Ls2s2s2', Score(limits=1))
        self.scoreTest(r's2 RDgDgDgDbDbDbDrDrDr b2b2b2b2 mee LDbDbDbDb', Score(32, 6))
    ...
    def testMJ(self):
        ...
        self.scoreTest(r'wewewe wswsws wnwnwnWn RWwWwWwC6 mee LC6', Score(32, 4))
