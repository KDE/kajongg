...
class RegTest(unittest.TestCase):
    ...
    def testRest(self):
        ...
        self.score(r'WeWeWe C3C3C3 c4c4c4C4 b8B8B8b8 S3S3', 'Meec4d L9999', expected=1792)
        ...
        self.score(r'B1B1B1B1B2B3B4B5B6B7B8B9DrDr fe fs fn fw ', 'MweDrd L0900', expected=832)
